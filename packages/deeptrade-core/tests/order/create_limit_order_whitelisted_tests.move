#[test_only]
module deeptrade_core::create_limit_order_whitelisted_tests;
...
fun success() {
    ...
    scenario.next_tx(ALICE);
    {
        ...
        // Execute limit buy order
        let order_info = create_limit_order_whitelisted<SUI, USDC>(
            &treasury,
            &mut fee_manager,
            &trading_fee_config,
            &loyalty_program,
...
fun test_not_supported_expire_timestamp() {
    ...
    scenario.next_tx(ALICE);
    {
        ...
        let _order_info = create_limit_order_whitelisted<SUI, USDC>(
            &treasury,
            &mut fee_manager,
            &trading_fee_config,
            &loyalty_program,
